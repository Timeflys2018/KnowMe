...
> 公测期支持开发者，享 Pro 永久优惠 + 早鸟 Pro 三年版（前 100 名 · 价格待公布）。
...
| **MCP 原生** | 被 AI agent 消费 —— Claude Code / Cursor 直接读你的知识库（只读，写入能力规划中） |
...
|---|---|
| **个人使用** | 免费 |
| **早鸟 Pro 三年版**（前 100 用户） | 价格待公布 · 一次付费享 3 年 Pro 全功能（3 年后与普通用户一致）|
