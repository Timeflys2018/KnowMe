...
5 分钟从安装到看到第一批 AI 编译的候选 Wiki。知我的本地笔记能力是**零配置**的：装好后直接拖一个 `.md` 进来就能写、能搜、能编辑；想看到 Wiki 编译和「问知我」，再配置一个你自己的 LLM Provider。
...
::: tip 最小闭环怎么跑
如果你只是想确认知我适不适合你，按这个顺序走：

1. 拖入一篇已有 Markdown。
2. 配置一个 LLM Provider。
3. 等待生成候选 Wiki。
4. 到 Review queue 接受 / 拒绝。
5. 回到笔记里圈选一句话，点「问知我」。
:::
